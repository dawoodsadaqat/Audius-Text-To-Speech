...
public sealed class SystemController : ControllerBase
{
    ...
    public SystemController(IOptions<RuntimeOptions> runtimeOptions)
    {
    ...
    public async Task<IActionResult> Check()
    {
        ...
        var ffmpegExists = !string.IsNullOrWhiteSpace(ffmpegPath);

        var pythonExists = System.IO.File.Exists(pythonPath);

        var edgeTtsInstalled =
            pythonExists &&
            await CheckPythonPackage(pythonPath, "edge_tts");

        var stableWhisperInstalled =
            pythonExists &&
            await CheckPythonPackage(pythonPath, "stable_whisper");
